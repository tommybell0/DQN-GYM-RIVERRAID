...
if policy_net.load_state_dict(torch.load("modelriverraid10.pt")):
    print("load modelriverraid10.pt")
target_net.load_state_dict(policy_net.state_dict())
optimizer = optim.AdamW(policy_net.parameters(), lr=LR, amsgrad=True)
memory = ReplayMemory(capacity=3000)
steps_done = 0
    ...
    for t in count():    
        ...
        if done:
            ...
            if total_reward > max_reward:
                ...
                if max_reward > 1.0:
                    torch.save(policy_net.state_dict(), "modelriverraid10.pt")
                    print("save model modelriverraid10.pt")
            total_reward=0
            plot_durations()
            break
print('Complete')
